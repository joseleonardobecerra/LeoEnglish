// data-grammar.js v5.0 — MÓDULOS DE GRAMÁTICA A1 y A2 (Pedagogical Edition)
// Contiene la teoría, ejercicios de gramática y toda la capa instruccional y heutagógica.
...
const modulesData = {
  ...
  adjectives_demo: {
    id: 'adjectives_demo', level: 'A1', title: 'Adjetivos y Demostrativos', icon: 'sparkles', color: '#9333EA',
  ...
  prepositions: {
    ...
    theory: `
      ...
      <p><strong>ON, IN</strong> y <strong>AT</strong> son las preposiciones más usadas en inglés básico.</p>
      <div class="theory-grid">
        <div class="t-box" style="border-color:#3182CE;background:#EBF8FF">
          <strong style="color:#1A365D">ON — días y superficies</strong>
          <small><b>Días:</b> on Monday · on 10th June<br>
          <b>Superficie:</b> on the table · on the wall</small>
        </div>
        ...
        <div class="t-box" style="border-color:#805AD5;background:#FAF5FF">
          ...
          <b>Lugares exactos:</b> at home · at school</small>
        </div>
      </div>`,
    exercises: [
      ...
      {type:'write',q:'Completa: I was born ___ 1998.',a:'in',exp:'Años → IN. "In 1998".'},
    ...
    theory: `
      ...
      <div class="theory-grid">
        <div class="t-box" style="border-color:#D97706;background:#FFFBEB">
          ...
          <small><b>I, you, he, she, it, we, they</b><br>"<u>She</u> is a doctor."</small>
        </div>
        <div class="t-box" style="border-color:#2563EB;background:#EFF6FF">
          <strong style="color:#1E3A8A">Objeto (Reciben la acción)</strong>
          <small><b>me, you, him, her, it, us, them</b><br>"Call <u>him</u>."</small>
        </div>
        <div class="t-box" style="border-color:#059669;background:#ECFDF5">
          <strong style="color:#064E3B">Posesivos Adjetivos</strong>
          <small><b>my, your, his, her, its, our, their</b><br>"<u>My</u> car."</small>
        </div>
      </div>`,
    exercises: [
    ...
    theory: `
      ...
      <div class="theory-grid">
        <div class="t-box" style="border-color:#E53E3E;background:#FFF5F5">
          ...
          <small>I <b>am</b> · You/We/They <b>are</b> · He/She/It <b>is</b></small>
        </div>
        <div class="t-box" style="border-color:#38A169;background:#F0FFF4">
          <strong style="color:#1C4532">TO HAVE — tener</strong>
          <small>I/You/We/They <b>have</b> · He/She/It <b>has</b></small>
        </div>
        <div class="t-box" style="border-color:#3182CE;background:#EBF8FF">
          <strong style="color:#1A365D">TO DO — hacer / auxiliar</strong>
          <small>I/You/We/They <b>do</b> · He/She/It <b>does</b></small>
        </div>
      </div>`,
    exercises: [
  ...
  present_simple: {
    ...
    learningGoal: 'Describir hábitos, rutinas, y verdades generales.',
    ...
    theory: `
      ...
      <div class="theory-grid">
        <div class="t-box" style="border-color:#38B2AC;background:#E6FFFA">
          ...
          <small>Señales: <b>always, usually, every day, never</b><br>"She <u>drinks</u> coffee every morning."</small>
        </div>
        <div class="t-box" style="border-color:#805AD5;background:#FAF5FF">
          <strong style="color:#4C1D95">CONTINUO → Ahora</strong>
          <small>Señales: <b>now, right now, at the moment, look!</b><br>"Look! It <u>is raining</u>!"</small>
        </div>
      </div>
  ...
  numbers: {
    ...
    stages: globalDidacticStages, methodology: globalMethodology, assessment: globalAssessment, progression: defaultProgression,
    theory: `
      <h3>Números y Plurales</h3>
      <div class="theory-grid">
        <div class="t-box" style="border-color:#D69E2E;background:#FEFCBF">
          <strong style="color:#78350F">Cardinales y Ordinales</strong>
          <small>
            13–19: + <b>teen</b> → thirteen, <b>fifteen</b><br>
            20–90: + <b>ty</b> → twenty, <b>forty</b> ⚠️<br>
            Ordinales: 1st <b>first</b>, 2nd <b>second</b>, 3rd <b>third</b>, 5th <b>fifth</b> ⚠️
          </small>
        </div>
        <div class="t-box" style="border-color:#059669;background:#ECFDF5">
          <strong style="color:#064E3B">Plurales Regulares e Irregulares</strong>
          <small>
            Regulares: car→cars, city→<b>cities</b>, wife→<b>wives</b><br>
            Irregulares: man→<b>men</b>, woman→<b>women</b>, child→<b>children</b>, person→<b>people</b>
          </small>
        </div>
      </div>`,
    exercises: [
    ...
    theory: `
      ...
      <div class="theory-grid">
        <div class="t-box" style="border-color:#C05621;background:#FFF5EB">
          ...
          <small>walk → walk<b>ed</b>, study → studi<b>ed</b>, stop → stop<b>ped</b></small>
        </div>
        <div class="t-box" style="border-color:#E53E3E;background:#FFF5F5">
          <strong style="color:#742A2A">Verbos IRREGULARES — memorizar</strong>
          <small>go→<b>went</b>, have→<b>had</b>, see→<b>saw</b>, buy→<b>bought</b></small>
        </div>
        <div class="t-box" style="border-color:#3182CE;background:#EBF8FF">
          <strong style="color:#1A365D">Negativo e interrogativo</strong>
          <small>Sujeto + <b>didn't</b> + verbo BASE<br><b>Did</b> + sujeto + verbo BASE?</small>
        </div>
      </div>`,
    exercises: [
  ...
  future_will: {
    id: 'future_will', level: 'A1', title: 'Futuro: Will', icon: 'chevrons-right', color: '#2C7A7B',
    ...
    stages: globalDidacticStages, methodology: globalMethodology, assessment: globalAssessment, progression: defaultProgression,
    theory: `
      <h3>Decisiones rápidas y Promesas</h3>
      <p>Usamos <strong>WILL</strong> para cosas no planeadas o ideas generales del futuro.</p>
      <div class="theory-grid">
        <div class="t-box" style="border-color:#2C7A7B;background:#E6FFFA">
          <strong style="color:#1D4044">WILL — usos principales</strong>
          <small>
            1. Decisión en el momento: "I'll answer the phone."<br>
            2. Predicción general: "I think it will rain."<br>
            3. Promesas: "I'll help you."<br>
            Negativo: <b>won't</b>
          </small>
        </div>
      </div>`,
  ...
  can_could: {
    id: 'can_could', level: 'A1', title: 'Modales: Can y Could', icon: 'shield', color: '#553C9A',
    ...
    theory: `
      ...
      <div class="theory-grid">
        <div class="t-box" style="border-color:#553C9A;background:#F5F3FF">
          ...
          <small>Habilidad: "I <b>can</b> swim."<br>Permiso: "<b>Can</b> I go?"</small>
        </div>
        <div class="t-box" style="border-color:#3182CE;background:#EBF8FF">
          <strong style="color:#1A365D">COULD (Pasado y Cortesía)</strong>
          <small>Pasado: "I <b>could</b> run fast."<br>Petición educada: "<b>Could</b> you help me?"</small>
        </div>
      </div>`,
    exercises: [
    ...
    theory: `
      ...
      <div class="theory-grid">
        <div class="t-box" style="border-color:#3182CE;background:#EBF8FF">
          ...
          <small>
            <b>Cortos:</b> +er &rarr; tall<b>er</b>, fast<b>er</b>.<br>
            <b>Largos:</b> more + adj &rarr; <b>more</b> beautiful.<br>
      ...
      <div class="theory-grid" style="margin-top:12px">
        <div class="t-box" style="border-color:#E53E3E;background:#FFF5F5">
          ...
          <small>
            ...
            Bad &rarr; worse (than) &rarr; the worst
          </small>
        </div>
      </div>`,
    exercises: [
    ...
    theory: `
      ...
      <div class="theory-grid">
        <div class="t-box" style="border-color:#38A169;background:#F0FFF4">
          ...
          <small>Tienen plural: apple/apples.<br>Usamos: <b>many</b> (muchos), <b>a few</b> (unos pocos).<br>"How <b>many</b> children do you have?"</small>
        </div>
        <div class="t-box" style="border-color:#E53E3E;background:#FFF5F5">
          <strong style="color:#742A2A">Sustantivos Incontables</strong>
          <small>No tienen plural: water, money, time.<br>Usamos: <b>much</b> (mucho), <b>a little</b> (un poco).<br>"We don't have <b>much</b> time."</small>
        </div>
      </div>
      <h3 style="margin-top:20px">Some vs Any</h3>
      <div class="theory-grid">
        <div class="t-box" style="border-color:#D97706;background:#FFFBEB">
    ...
    theory: `
      ...
      <div class="theory-grid">
        <div class="t-box" style="border-color:#805AD5;background:#FAF5FF">
          ...
          <small>(+) I <b>was watching</b> TV.<br>(-) They <b>weren't listening</b>.</small>
        </div>
        <div class="t-box" style="border-color:#E53E3E;background:#FFF5F5">
          <strong style="color:#742A2A">When / While</strong>
          <small><b>When (cuando):</b> Seguido de Past Simple (la interrupción).<br>
          "I was sleeping <u>when</u> the phone <u>rang</u>."<br><br>
          <b>While (mientras):</b> Seguido de Past Continuous (la acción larga).</small>
        </div>
      </div>`,
    exercises: [
  ...
  present_perfect: {
    id: 'present_perfect', level: 'A2', title: 'Present Perfect', icon: 'star', color: '#D69E2E',
    ...
    theory: `
      ...
      <p>El Present Perfect conecta el pasado con el presente cuando <strong>NO importa cuándo</strong> ocurrieron las cosas.</p>
      <div class="theory-grid">
        <div class="t-box" style="border-color:#D69E2E;background:#FEFCBF">
          <strong style="color:#78350F">Estructura: Have/Has + Participio Pasado (V3)</strong>
          <small>(+) I <b>have visited</b> London.<br>(-) He <b>hasn't called</b>.<br>(?) <b>Have</b> you <b>eaten</b> sushi?</small>
        </div>
      </div>
      <h3 style="margin-top:20px">Palabras Clave</h3>
      <div class="theory-grid">
        <div class="t-box" style="border-color:#38B2AC;background:#E6FFFA">
          <strong style="color:#1D4044">Ever / Never</strong>
          <small>¿Alguna vez? / Nunca (experiencia 0).</small>
        </div>
        <div class="t-box" style="border-color:#3182CE;background:#EBF8FF">
          <strong style="color:#1A365D">Just / Already / Yet</strong>
          <small>Recién / Ya / Todavía no (al final en - y ?).</small>
        </div>
      </div>`,
    exercises: [
  ...
  future_mixed: {
    id: 'future_mixed', level: 'A2', title: 'Future Mixed', icon: 'zap', color: '#3182CE',
    ...
    theory: `
      ...
      <div class="theory-grid">
        <div class="t-box" style="border-color:#38A169;background:#F0FFF4">
          ...
          <small>Citas y planes 100% confirmados en agenda.<br>"I <b>am meeting</b> the dentist at 5 PM."</small>
        </div>
        <div class="t-box" style="border-color:#2C7A7B;background:#E6FFFA">
          <strong style="color:#1D4044">Will (Predicciones / Promesas)</strong>
          <small>"I think cars <b>will fly</b> in 2050." (Predicción).<br>"I <b>will always love</b> you." (Promesa).</small>
        </div>
      </div>`,
    exercises: [
  ...
  modals_obligation: {
    ...
    theory: `
      ...
      <div class="theory-grid">
        <div class="t-box" style="border-color:#C05621;background:#FFF5EB">
          <strong style="color:#7B341E">Must vs Have To</strong>
          <small><b>Must:</b> Obligación interna. "I <u>must</u> study."<br><b>Have to:</b> Obligación externa. "I <u>have to</u> wear a uniform."</small>
        </div>
        <div class="t-box" style="border-color:#E53E3E;background:#FFF5F5">
          <strong style="color:#742A2A">Mustn't vs Don't have to</strong>
          <small><b>Mustn't:</b> PROHIBICIÓN estricta.<br><b>Don't have to:</b> Opcional / No es necesario.</small>
        </div>
        <div class="t-box" style="border-color:#38A169;background:#F0FFF4">
          <strong style="color:#1C4532">Should (Consejo)</strong>
          <small>"You <u>should</u> see a doctor." (Deberías).</small>
        </div>
      </div>`,
    exercises: [
      ...
      {type:'write',q:'Completa: We ___ to wear a uniform at my school.',a:'have',exp:'have to (obligación externa).'},
  ...
  conditionals: {
    id: 'conditionals', level: 'A2', title: 'Zero & First Conditional', icon: 'git-branch', color: '#805AD5',
    ...
    theory: `
      ...
      <div class="theory-grid">
        <div class="t-box" style="border-color:#805AD5;background:#FAF5FF">
          ...
          <small><b>If + Present Simple, Present Simple</b>.<br>"If you heat water to 100°C, it boils."</small>
        </div>
        <div class="t-box" style="border-color:#38B2AC;background:#E6FFFA">
          <strong style="color:#1D4044">First Conditional (Posible futuro)</strong>
          <small><b>If + Present Simple, WILL + verbo base</b>.<br>"If I study hard, I will pass the exam."</small>
        </div>
      </div>`,
    exercises: [
    ...
    theory: `
      ...
      <div class="theory-grid">
        <div class="t-box" style="border-color:#E53E3E;background:#FFF5F5">
          ...
          <small>Si un verbo va después de una preposición (in, on, at, for, of), SIEMPRE lleva -ING.<br>"I am good <b>at playing</b> tennis."</small>
        </div>
        <div class="t-box" style="border-color:#D97706;background:#FFFBEB">
          <strong style="color:#78350F">2. Como sujeto de la oración</strong>
          <small>"<b>Smoking</b> is bad for you."<br>"<b>Learning</b> English is fun."</small>
        </div>
        <div class="t-box" style="border-color:#38A169;background:#F0FFF4">
          <strong style="color:#1C4532">3. Después de ciertos verbos</strong>
          <small>Verbos como enjoy, mind, suggest, stop.<br>"I enjoy <b>reading</b>."</small>
        </div>
      </div>`,
    exercises: [
